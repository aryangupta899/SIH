        ...
        <div className='col-md-6'>
          ...
          <Form className="formalign normalBackground animate__animated animate__fadeIn">
            ...
            <Form.Group className="mb-3" controlId="formBasicCertiNo">
              ...
              <Form.Control className="inputData" name="email" type="email" placeholder="Enter Certificate Number" required={true} />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="formBasicJointAcHolder">
              <Form.Label className="field">College Name</Form.Label>
              <Form.Control className="inputData" name="jointAcHolder" type="text" placeholder="Enter College Name" required={true} />
            </Form.Group>
